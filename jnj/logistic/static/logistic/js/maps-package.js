...
function initMap() {
  ...
  // ****** START when the branch selected *****

  var onBranchChangeHandler = function() {
    var branch_origin = document.getElementById('pac-input-branch').value;
    var drop_to_branch = document.getElementById('pac-input-drop_to_branch');
    if (branch_origin.trim() == '' || branch_origin.trim() == '') {
        input_origin.value = '';
        input_origin.readOnly = false;
        drop_to_branch.value = 'N';
    } else {
      input_origin.value = document.getElementById('pac-input-branch').value;
      input_origin.readOnly = true;
      drop_to_branch.value = 'Y';
    }
  };
  document.getElementById('pac-input-branch').addEventListener('change', onBranchChangeHandler);

  // ****** END   when the branch selected *****
